...
cam_mat, dist_coef, r_vectors, t_vectors = AM.load_calib_data("./lib/calib_data/MultiMatrixBasler.npz")
...
def ros_node_setup():
    ...
    rospy.Subscriber('/camera_adapter_node/camera_feed', ros_std_msgs.String, _ros_frame_process)

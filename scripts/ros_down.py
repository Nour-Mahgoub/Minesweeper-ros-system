...
log_man.print_log(MODULE_ID, 'INFO', 'stopping slave ROS nodes')
...
log_man.print_log(MODULE_ID, 'INFO', 'slave ROS nodes stopped')

log_man.print_log(MODULE_ID, 'INFO', 'shutting down ROS master')
os.system('docker compose down')
log_man.print_log(MODULE_ID, 'INFO', 'finished shutting down ROS master')
